...
public class DESDemo {
    ...
    public static void main(String[] args) throws Exception {
        String key = "12345678";
        String original = "你好11";
        String encryptByDES = encryptByDES(key, original);

        System.out.println(encryptByDES);
        String decryptByDES = decryptByDES(key, original);
        System.out.println(decryptByDES);
    }

    public static String encryptByDES(String key, String original) throws Exception {
        // 获取Cipher
    ...
    public static String decryptByDES(String key, String encrypted) throws Exception {
        // 获取Cipher
        Cipher cipher = Cipher.getInstance(transformation);
